...
export const GET_ALL_REKRUTACJA_MERCHANDISER_DETAILS = gql`
  query GetAllRekrutacjaMerchandiserDetails {
    klient {
      id
      name
      phone
...
export const GET_ALL_KLIENTS = gql`
  query GetAllClients {
    klient {
      id
      name
...
export const GET_ALL_MAKETS = gql`
  query GetAllMarkets {
    market {
      id
      name
...
export const GET_ALL_REKRUTACJE = gql`
  query GetAllRekrutacje {
    group: rekrutacja {
      id
      status: rekrutacja_status {
        name: status_name
      }
      data_zgloszenia
      rekrutacja_typ {
      ...
      rekrutacja_hostessa_tks {
        id
      }

      rekrutacja_merchandiser_mobilny_phs {
        id
      }
...
export const GET_REKRUTACJE_MERCHANDISER = gql`
  query GetRekrutacjeMerchandiser {
    group: rekrutacja(
      where: { rekrutacja_typ: { name: { _eq: "merchandiser" } } }
    ) {
      id
      status: rekrutacja_status {
        name: status_name
...
// ! wszystko pod spodem do wywalenia //
