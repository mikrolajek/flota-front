...
export const getObjectToSend = (
  data: ISendMerchandiserMobilnyFlat,
  user_id: number
) => {
  const dataToInsert: dataToSendMerchandiserMobilny = {
    miasto: data.miasto,
...
export interface dataToSendMerchandiserMobilny {
  miasto: string;
  wojewodztwo: string;
...
export interface ISendMerchandiserMobilnyFlat {
  id_koordynator_regionalny: number;
  id_market: number;
  id_klient: number;
  wynagrodzenie_miesieczne: number;
